...
class TaskA2 {
    public static void main(String[] args) {
        String a= "Есть луг волшебный, что лежит вне круга";
        String b= "Понятий наших о добре и зле.";
        String c= "Ищи его! Там встретим мы друг друга.";
        String d= "Мы встретиться не можем на земле.";
